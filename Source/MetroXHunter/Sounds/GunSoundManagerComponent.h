...
public:
	...
	/*
	 * Called when the expulsed bullet shell collided with something.
	 */
	UFUNCTION( BlueprintCallable, BlueprintImplementableEvent )
	void OnRifleShellCollide( AActor* ShellActor, bool bIsFirstCollision );
	/*
	 * Called when the cocking animation triggers.
	 */
	UFUNCTION( BlueprintCallable, BlueprintImplementableEvent )
	void OnRifleCocking();
	...
	/*
	 * Called when the tesla gun starts charging before shooting.
	 */
	UFUNCTION( BlueprintCallable, BlueprintImplementableEvent )
	void OnLightningStartCharging();
	/*
	 * Called when the player stops charging the tesla gun before entering in shooting state.
	 */
	UFUNCTION( BlueprintCallable, BlueprintImplementableEvent )
	void OnLightningStopCharging();
	/*
