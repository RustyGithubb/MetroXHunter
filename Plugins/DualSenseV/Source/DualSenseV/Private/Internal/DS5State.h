...
namespace DS5W {
	...
	// arkaht: I'm changing the struct to directly use it as an array of bytes
	// so it's less work to maintain the conversion between user and low-level codes.
	typedef unsigned char TriggerEffect[11];
