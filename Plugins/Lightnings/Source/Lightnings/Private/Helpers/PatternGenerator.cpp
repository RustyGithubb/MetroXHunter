...
void FPatternGenerator::MakeLightningPattern(FLightningPattern& OutPattern, const FPatternParams& Params)
{
	...
	InitializePoint(OutPattern, Params, OutPattern.Points.Num() - 1, 1.f);
...
void FPatternGenerator::InitializePoint(FLightningPattern& Pattern, const FPatternParams& Params, uint32 PtIndx, float CurveAlpha)
{
