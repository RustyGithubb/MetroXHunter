...
void UVentManagerComponent::ClearEnemiesInAllZones()
{
	for ( int32 Index = 0; Index < (int32)EVentZone::MAX; Index++ )
	{
		ZoneEnemies[Index] = 0;
	}
	...
	UUtilityLibrary::LogMessage( TEXT( "%s: Cleared enemies in all zones" ), *GetName() );
}
