...
public:
	...
	*/
	...
	UFUNCTION( BlueprintCallable, Category = "UtilityLibrary" )
	static void ForceLoadAssetsAtPath( FName Path );
	...
	UFUNCTION( BlueprintCallable, Category = "UtilityLibrary", meta = ( WorldContext = "WorldContextObject" ) )
	static void SetConsoleOpened( UObject* WorldContextObject, bool bIsOpened = true, bool bIsFull = false );
};
