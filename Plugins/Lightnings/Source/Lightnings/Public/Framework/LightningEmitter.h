...
DECLARE_LOG_CATEGORY_EXTERN( LogMetroLightningEmitter, Log, All );
...
public :
	...
	TSubclassOf<AActor> BP_ScorchDecals;

	UPROPERTY( EditDefaultsOnly, Category = "Pooling" )
	TSubclassOf<AActor> BP_LightningProjectile;

	UPROPERTY( BlueprintReadOnly, Category = "Pooling" )
	UPoolManager* PoolManager = nullptr;
