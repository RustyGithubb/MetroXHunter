...
public:
	...
	UPROPERTY( EditAnywhere, BlueprintReadWrite, Category = "CharacterController|Ability|Input" )
	bool bIsToggleRunMode = true;
...
private:
	...
	FVector2D LastInputDirection {0};
	float DotPrecision = 0.05f;
	float DotTimer = 0.0f;
};
