...
public:
	...
	UPROPERTY( EditAnywhere, BlueprintReadOnly, Category = "Attacks|Spit", meta = ( Units = "Centimeters" ) )
	float SpitSpreadRange = 300.0f;
	/*
	 * Token to reserve to the target's AITargetComponent before performing a spit attack.
	 */
	UPROPERTY( EditAnywhere, BlueprintReadOnly, Category = "Attacks|Spit" )
	int32 SpitTokens = 1;
	/*
	 * Time to apply as a cooldown to the target's AITargetComponent
	 * after a spit token has been freed.
	 */
	UPROPERTY( EditAnywhere, BlueprintReadOnly, Category = "Attacks|Spit", meta = ( Units = "Seconds" ) )
	float SpitTokenCooldown = 1.5f;

	UPROPERTY( EditAnywhere, BlueprintReadOnly, Category = "Attacks|CallForParasites", meta = ( Units = "Centimeters" ) )
	float CallForParasitesRadius = 4000.0f;
	UPROPERTY( EditAnywhere, BlueprintReadOnly, Category = "Attacks|CallForParasites" )
	FInt32Range CallForParasitesCountRange { 2, 3 };
