...
static TAutoConsoleVariable<bool> ConvarAINoQTE(
	TEXT( "MXH.AI.NoQTE" ),
	false,
	TEXT( "Prevent quick time events from happening.\n" ),
	ECVF_Cheat | ECVF_SaveForNextBoot
);

bool UConvarLibrary::IsAINoQTEConvarEnabled()
{
	return ConvarAINoQTE.GetValueOnAnyThread();
}
