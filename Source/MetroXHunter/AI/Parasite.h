...
public:
	...
	UFUNCTION( BlueprintCallable, Category = "Parasite" )
	void SetStompLocked( bool bIsLocked );
	UFUNCTION( BlueprintPure, Category = "Parasite" )
	bool IsStompLocked() const;
...
private:
	...
	void UnSimulateRagdoll();

	void ResolveLocationFromRagdoll();

private:
	/*
	 * Whenever the parasite is locked by the player to get stomp.
	 */
	bool bIsStompLocked = false;
