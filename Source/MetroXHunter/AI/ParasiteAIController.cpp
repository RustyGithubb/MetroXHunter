...
constexpr auto IS_STUNNED_KEYNAME = TEXT( "bIsStunned" );
...
void AParasiteAIController::OnPossess( APawn* InPawn )
{
	...
	CustomPawn->OnStunned.AddDynamic( this, &AParasiteAIController::OnStunned );
...
void AParasiteAIController::OnStunned( bool bIsStunned )
{
	Blackboard->SetValueAsBool( IS_STUNNED_KEYNAME, bIsStunned );
}
